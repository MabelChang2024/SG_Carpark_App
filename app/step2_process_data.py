...
for item in lta_data["value"]:
    if item["Area"] != "":   #!= means not equals to #" " coz you don't want the HDB carpark data 
...
total_lots = total_lots[1:]   #index position 1 till the end #first element is 0 
...
#set is another type of data structure 
#set removes all duplicated values. Use set when you want to keep the unique name of the street 
...
#.streamlit file is for designing the background etc 
#when you use a streamlit app, you must have a subfile called .streamlit 
#and specify the colours etc 